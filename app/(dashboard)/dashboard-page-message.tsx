...
export function DashboardPageMessage({
  ...
  return (
    <section className="flex min-h-[320px] w-full items-center justify-center rounded-2xl border border-[#d8dadc] bg-[#f7f9fb] px-4 py-10 text-center shadow-[0_4px_6px_-1px_rgb(0_0_0/0.05),0_2px_4px_-2px_rgb(0_0_0/0.05)] sm:px-5">
